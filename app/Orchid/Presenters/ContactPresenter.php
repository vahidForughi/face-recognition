...
class ContactPresenter extends Presenter implements Personable, Searchable
{
    /**
    ...
    {
        return $this->entity->sender_name;
    }
    ...
    {
        return $this->entity->sender_mobile . '</br>' . $this->entity->sender_email;
    }
    ...
    {
        return "/storage/local/uploads/contact/{$this->entity->sender_image}";
    }
