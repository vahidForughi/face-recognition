...
<!--    </section>-->
    <section>
        <div class="pt-5">
        <div class="d-flex flex-row justify-content-center align-items-center gap-lg-4 gap-sm-2  p-lg-4 p-sm-2"
             style="background-color: #7c41a8; max-width: 300px; border-radius: 50px 0 0 50px">
